...
namespace AuthenticDeathclaws.Common.Races.Deathclaws
{
	public class Deathclaw : Race
	{
        //display name, used to override the race's displayed name. By default, a race will use its class name
        public override string RaceDisplayName => "Deathclaw";
		...
		public override string RaceEnvironmentOverlay1Icon => ($"AuthenticDeathclaws/Common/UI/RaceDisplay/Environment/EnvironmentOverlay_Mushcloud");
		...
		public override string RaceSelectIcon => ($"AuthenticDeathclaws/Common/UI/RaceDisplay/DeathclawSelect");
		public override string RaceDisplayMaleIcon => ($"AuthenticDeathclaws/Common/UI/RaceDisplay/DeathclawDisplayMale");
        public override string RaceDisplayFemaleIcon => ($"AuthenticDeathclaws/Common/UI/RaceDisplay/DeathclawDisplayFemale");
		public override string RaceLore1 => "Genetically altered" + "\nto survive a harsh" + "\nwasteland, they're now" + "\nthe Apex Predator.";
        public override string RaceLore2 => "Gifted with sentience" + "\ndue to cruel experiments," + "\nthey search for meaning.";
		...
		public override string RaceThornsDisplayText => "[c/34EB93:+5%]";
		...
		public override string RaceMeleeSpeedDisplayText => "[c/34EB93:+10%]";
		...
		public override string RaceMeleeCritChanceDisplayText => "[c/34EB93:+2%]";
		...
		public override void ModifyDrawLayers(Player player, List<PlayerLayer> layers)
		{
			...
			Main.playerTextures[0, 3] = ModContent.GetTexture("AuthenticDeathclaws/Content/RaceTextures/Deathclaw/Deathclaw_Torso");
			...
			Main.playerTextures[1, 3] = ModContent.GetTexture("AuthenticDeathclaws/Content/RaceTextures/Deathclaw/Deathclaw_Torso");
			...
			Main.playerTextures[2, 3] = ModContent.GetTexture("AuthenticDeathclaws/Content/RaceTextures/Deathclaw/Deathclaw_Torso");
			...
			Main.playerTextures[3, 3] = ModContent.GetTexture("AuthenticDeathclaws/Content/RaceTextures/Deathclaw/Deathclaw_Torso");
			...
			Main.playerTextures[8, 3] = ModContent.GetTexture("AuthenticDeathclaws/Content/RaceTextures/Deathclaw/Deathclaw_Torso");
			...
			Main.playerTextures[4, 3] = ModContent.GetTexture("AuthenticDeathclaws/Content/RaceTextures/Deathclaw/Deathclaw_Torso");
			...
			Main.playerTextures[5, 3] = ModContent.GetTexture("AuthenticDeathclaws/Content/RaceTextures/Deathclaw/Deathclaw_Torso");
			...
			Main.playerTextures[6, 3] = ModContent.GetTexture("AuthenticDeathclaws/Content/RaceTextures/Deathclaw/Deathclaw_Torso");
			...
			Main.playerTextures[7, 3] = ModContent.GetTexture("AuthenticDeathclaws/Content/RaceTextures/Deathclaw/Deathclaw_Torso");
			...
			Main.playerTextures[9, 3] = ModContent.GetTexture("AuthenticDeathclaws/Content/RaceTextures/Deathclaw/Deathclaw_Torso");
